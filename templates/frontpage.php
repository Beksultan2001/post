                ...
                <div class="col-sm-5 col-md-5 col-lg-4 each">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card_username"><span>Автор: </span><?php echo $list->username ?></p>

                            <p class="card_date"><span>Пост cалынды:</span> <?php echo $list->post_date; ?></p>

                            <a class="card_button" href="common.php?id=<?php echo $list->id ?>">Көру</a>
